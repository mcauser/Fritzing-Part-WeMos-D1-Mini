...
rm -rf dist/WeMos-D1-mini-female-headers-above.fzpz
...
rm -rf dist/WeMos-D1-mini-male-headers-above.fzpz
...
rm -rf dist/WeMos-D1-mini-male-headers-below.fzpz
...
rm -rf dist/WeMos-D1-mini-no-headers.fzpz
